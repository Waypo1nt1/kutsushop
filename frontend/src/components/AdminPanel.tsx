...
export function AdminPanel(props: Props) {
      ...
      <ul className="space-y-2 tracking-wide mt-8">
        <li>
          ...
          >
            ...
            <span className="-mr-1 font-medium">Заказы</span>
          </a>
        </li>
        <li>
          <a
        ...
        <li>
          ...
          >
            ...
            <span className="group-hover:text-white-700">Модели обуви</span>
          </a>
        </li>
        <li>
          <a
  ...
  <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
    <div className=" bg-slate-800 z-10 top-0 h-16 border-b bg-white lg:py-2.5">
