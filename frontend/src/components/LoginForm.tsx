                ...
                <div className="rounded-[calc(1.5rem-1px)] bg-white px-10 p-12 dark:bg-gray-900">
                  <div>
                    <h1 className="text-xl font-semibold text-gray-800 dark:text-white pb-4">Аккаунт администратора</h1>
                      <p className="text-sm tracking-wide text-gray-600 dark:text-gray-300"> Для доступа к административной панели, войдите в аккаунт <a href="" className="text-blue-600 transition duration-200 hover:underline dark:text-blue-400"> </a> </p>
                  </div>
