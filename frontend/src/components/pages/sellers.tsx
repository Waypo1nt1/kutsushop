...
const Button = () =>
  ...
  const setId = (id: any, name: any, surname: any, middle_name: any, phone_number: any, position: any, uid: any) => {
    location.href = "http://localhost:5173/editform?id=" + String(id) + "&name=" + String(name) + "&surname=" + String(surname) + "&middlename=" + String(middle_name) + "&phone_number=" + String(phone_number) + "&position=" + String(position) + "&uid=" + String(uid)
  }
